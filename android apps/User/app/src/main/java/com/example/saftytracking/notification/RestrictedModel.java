...
public class RestrictedModel {
    ...
    public RestrictedModel() {
        this.restrictedId = UUID.randomUUID().toString();
    ...
    public RestrictedModel(String restrictedId, String restrictedName, CornerModel cornerModel1, CornerModel cornerModel2, CornerModel cornerModel3, CornerModel cornerModel4, CornerModel cornerModel5, CornerModel cornerModel6, CornerModel cornerModel7, CornerModel cornerModel8) {
