...
public class AddFloorActivity extends AppCompatActivity {
    ...
    private ActivityAddFloorBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAddFloorBinding.inflate(getLayoutInflater());
...
//                        Log.d(TAG, "onLocationResult: " + floorModel.get);
                    ...
                    Toast.makeText(AddFloorActivity.this, "Unable to fetch location. Please enable GPS.", Toast.LENGTH_SHORT).show();
                }
            }
        };
        ...
        binding.btnSubmit.setOnClickListener(v -> {
            if (validate()) {
                String floorName = binding.etFloorName.getText().toString();
                double floorHeight = Double.parseDouble(binding.etFloorHeight.getText().toString());

                floorModel.setFloorName(floorName);
                ...
                firebaseFirestore
                        ...
                        .collection("floors")
                        .document(floorModel.getFloorId())
                        .set(floorModel)
                        .addOnSuccessListener(aVoid -> {
                            Toast.makeText(this, "Floor Added", Toast.LENGTH_SHORT).show();

                            Intent intent = new Intent(AddFloorActivity.this, MainActivity.class);
